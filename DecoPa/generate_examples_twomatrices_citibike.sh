...
python3.10 generate_trace_citibike.py ../plans/parallel_example/matrix.txt ../plans/stateparallel_example/matrix.txt 1 -f citibike_1d1min_2023_10_10.csv -M $scaling -a $alphabet
cd traces/
